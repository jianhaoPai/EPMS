...
public interface UserMapper {
    ...
    */
	...
	//添加新个人信息
	public int addPersonalInfo(@Param("jobId")int jobId,@Param("name") String name,@Param("denameId") String denameId,@Param("ocnameId")String ocnameId);
	//取出总经理工号
	...
	//获取该部门最后的工号
	public Integer selectLastJobId(@Param("denameId")String denameId);
