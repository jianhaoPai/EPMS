...
import com.epms.Mapper.PerformScoreMapper;
import com.epms.Mapper.PerformSumMapper;
import com.epms.Service.PerformSumService;
...
public class PerformSumServiceImpl implements PerformSumService{
	...
	//获取绩效评价
	public PerformSum selectPerform(int jobId,String type,String assessDate){
		return performSumMapper.selectPerform(jobId,type,assessDate);
	}
}
