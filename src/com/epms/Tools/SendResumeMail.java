...
public class SendResumeMail {
			...
			public static String sendEmailAccount = "1012993912@qq.com";
			// 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
			public static String sendEmailPassword = "aqtkmvxcavwubajc";
			...
			public void sendResume(String receiveMailAccount, String mailContent) {
				// 创建用于连接邮件服务器的参数配置
			...
			public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
				...
				// 设置邮件主题
				message.setSubject("发送招聘结果", "UTF-8");
