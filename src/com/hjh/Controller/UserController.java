...
public class UserController {
	...
	public @ResponseBody String addAccount(@Valid User user,Errors errors,String name,int denameId){
		...
		if(errors.hasErrors()){
			...
			//返回结果
			if(addUser==null){
				userService.addAccount(jobId,name,denameId, password);
	...
	@ResponseBody
	public String editAccount(Model model,String jobId,String password,String state,String denameId){
		int jobid=Integer.parseInt(jobId);
		JSONObject data = new JSONObject();
		if(userService.editAccount(jobid,password,state,denameId)==1){
