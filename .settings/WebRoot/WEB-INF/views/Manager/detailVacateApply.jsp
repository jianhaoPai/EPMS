...
<html>
		...
		<form  class="layui-form" method="post" id="submitFeedBackForm">
		   <div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
				<input type="text" id="start_date"  name="start_date" class="layui-input" readonly/>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
				<input type="text" id="finish_date"  name="finish_date" class="layui-input" readonly/>
				</div>
			</div>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">销假时间:</label>
				<div class="layui-inline">
				<input type="text" id="cancel_date"  name="cancel_date" class="layui-input" readonly/>
				</div>
			</div>
  ...
  layui.use(['form','jquery','layer'],function(){
	  ...
	  $(document).on('click','#submitAccount',function(){
				$.ajax({
					url:'VacateController/updateVacateApply',
