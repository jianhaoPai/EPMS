 ...
 <form class="layui-form" action="" method="post">
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="jobId" value="${requestScope.partyinfo.jobId}" lay-verify="required|number" autocomplete="off" class="layui-input" readonly> 
        </div>
      </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="name" value="${requestScope.partyinfo.partyOccupation}" lay-verify="required|number" autocomplete="off" class="layui-input" readonly>
        </div>
      </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="sex" value="${requestScope.partyinfo.partyIdentity}" lay-verify="required|number" autocomplete="off" class="layui-input" readonly>
        </div>
      </div>
    </form>
...
<div class="layui-row" id="submitFeedBack" style="display:none;">
	...
	<form class="layui-form" id="addAccountForm" method="post">
     <label class="layui-form-label">反馈类型:</label>
      ...
      <div class="layui-col-md12">
        ...
        <div class="layui-inline">
          <textarea name="reason" placeholder="请输入反馈具体原因" class="layui-textarea"></textarea>
        </div>
      </div>
      </div>
    ...
    ${requestScope.selectPartyinfoMess}
	</div>
</div>
				...
				$.ajax({
					...
					success:function(result){
						if(result){
							...
							layer.alert("提交失败，填写信息不完整！",function(){
								window.location.reload();//刷新父页面
								parent.layer.close();//关闭当前弹窗
					        });	
						}
