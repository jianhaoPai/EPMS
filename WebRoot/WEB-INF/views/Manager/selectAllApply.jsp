...
layui.use(['jquery','table','layer','form'],function(){
            ...
            ,url:'ApplyController/selectAllApply'  //数据请求路径
            ,cellMinWidth: 80
            ,cols: [[
            	   {type:'numbers',title:'序号',fixed:'left',align: 'center'}
                  ,{field:'writeName', title:'提交人姓名',align: 'center',sort:'true'}
          ...
          $('.demoTable .layui-btn').on('click', function(){
			...
			table.on('tool(testForm)',function(obj){
			    ...
			    if(layEvent==='update'){
		            ...
		            skin:"myclass",
		            area:["50%","70%"],
		            content:["requestPage?page=Manager/detailApply","no"],
