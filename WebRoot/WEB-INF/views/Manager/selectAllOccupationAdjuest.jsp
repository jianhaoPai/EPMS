...
<title>所有直接下属提交的职位调动申请信息</title>
<link rel="stylesheet" type="text/css" href="layui/css/layui.css">
</head>
<body>
  <blockquote class="layui-elem-quote layui-text">
    <h3>- 直接下属提交的职位调动申请信息 -</h3>
  </blockquote>
...
layui.use(['jquery','table','layer','form'],function(){
            ...
            ,url:'OccupationAdjustController/selectAllOccupationAdjuest'  //数据请求路径
            ,cellMinWidth: 80
            ,cols: [[
          ...
          $('.demoTable .layui-btn').on('click', function(){
			...
			table.on('tool(testForm)',function(obj){
			    ...
			    if(layEvent==='update'){
		            ...
		            skin:"myclass",
		            area:["45%","95%"],
		            content:["requestPage?page=Manager/detailOccupationAdjust","no"],
		            success:function(layero,index){
                        ...
                        $(inputList[1]).val(data.PreDepartmentName);
                        $(inputList[2]).val(data.PreOccupationName);
                        $(inputList[3]).val(data.ToDepartmentName);
                        $(inputList[4]).val(data.ToOccupationName);
		            },
		            end:function(result){
