...
<title>所有直接下属提交的薪资调动申请信息</title>
<link rel="stylesheet" type="text/css" href="layui/css/layui.css">
</head>
<body>
  <blockquote class="layui-elem-quote layui-text">
    <h3>- 直接下属提交的薪资调动申请信息 -</h3>
  </blockquote>
...
layui.use(['jquery','table','layer','form'],function(){
            ...
            ,url:'SalaryAdjustController/selectAllSalaryAdjust'  //数据请求路径
            ,cellMinWidth: 80
            ,cols: [[
			...
			table.on('tool(testForm)',function(obj){
			    ...
			    if(layEvent==='update'){
		            ...
		            success:function(layero,index){
                        ...
                        $(inputList[0]).val(data.apply_id);
                        $(inputList[1]).val(data.salaryadjust_type);
                        $(inputList[2]).val(data.salaryadjust_money);
		            },
		            end:function(result){
