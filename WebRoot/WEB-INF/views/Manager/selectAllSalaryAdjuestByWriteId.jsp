...
<title>所有提交给直接上级的所有薪资调动申请信息</title>
<link rel="stylesheet" type="text/css" href="layui/css/layui.css">
</head>
<body>
  <blockquote class="layui-elem-quote layui-text">
    <h3>- 提交给直接上级的薪资调动申请信息 -</h3>
  </blockquote>
...
<form class="layui-form layui-form-pane" action="">
  <div class="demoTable">
      ...
      <div class="layui-inline">
        <select name="salaryadjust_type" id="salaryadjust_typeReload">
             <option value="">请选择薪资调动类型</option>
...
layui.use(['jquery','table','layer','form'],function(){
            ...
            ,url:'SalaryAdjustController/selectAllSalaryAdjustByWriteId'  //数据请求路径
            ,cellMinWidth: 80
            ,cols: [[
                  ...
                  ,{field:'salaryadjust_type', title:'薪资调动类型',align: 'center'}
            ...
            ,id: 'test'  
            ,text:{
			none:'暂时无提交给上级的薪资调动申请记录'
			}
          });
          
          var $ = layui.$, active = {
		    reload: function(){
		      var salaryadjust_typeReload = $('#salaryadjust_typeReload').val();
		      ...
		      table.reload('test', {
		        ...
		        ,where: {
		            salaryadjust_type: salaryadjust_typeReload,
		            state: stateReload,
          ...
          $('.demoTable .layui-btn').on('click', function(){
			...
			table.on('tool(testForm)',function(obj){
			    ...
			    if(layEvent==='update'){
		            ...
		            skin:"myclass",
		            area:["40%","50%"],
		            content:["requestPage?page=Manager/detailSalaryAdjustByWritedId","no"],
		            success:function(layero,index){
                        ...
                        $(inputList[0]).val(data.salaryadjust_type);
                        $(inputList[1]).val(data.salaryadjust_money);
		            },
		            end:function(result){
